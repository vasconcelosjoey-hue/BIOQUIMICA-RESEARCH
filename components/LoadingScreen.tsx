...
const LoadingScreen: React.FC = () => {
  // URL da imagem enviada pelo usuário
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-teal-950 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        <div className="w-28 h-28 md:w-36 md:h-36 mb-10 relative">
          <div className="absolute inset-[-10px] bg-teal-500/20 blur-2xl rounded-full animate-pulse"></div>
          <div className="relative bg-white p-1 w-full h-full rounded-full flex items-center justify-center shadow-2xl shadow-teal-500/40 animate-float overflow-hidden">
            <img src={researcherImg} className="w-full h-full object-cover rounded-full" alt="Researcher Loading" />
          </div>
          <div className="absolute -bottom-2 -right-2 bg-teal-600 text-white w-10 h-10 rounded-full border-4 border-teal-950 flex items-center justify-center">
             <i className="fas fa-dna text-xs animate-dna"></i>
          </div>
        </div>
